    ...
    hebench::cpp::BaseBenchmark(engine, bench_desc, bench_params)
{
    ...
    m_p_ctx_wrapper = SEALContextWrapper::createCKKSContext(DotProductBenchmarkDescription::DefaultPolyModulusDegree,
                                                            DotProductBenchmarkDescription::DefaultMultiplicativeDepth,
                                                            DotProductBenchmarkDescription::DefaultCoeffMudulusBits,
                                                            DotProductBenchmarkDescription::DefaultScaleBits,
